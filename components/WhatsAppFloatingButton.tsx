...
export default function WhatsAppFloatingButton() {
  ...
  return (
    <a
      ...
      className="fixed bottom-5 right-5 z-50 inline-flex items-center justify-center w-14 h-14 rounded-full bg-green-600 text-white shadow-lg hover:bg-green-500 transition-colors"
    >
