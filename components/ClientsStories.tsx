    ...
    () => [
      {
        id: "bmpes",
        name: "BMPES",
        logoSrc: "/clientes/bmpes.png",
        stories: ["/clientes/stories/bmpes/bmstory.png"],
      },
      {
        id: "hiper",
        name: "Hipermercado Coração",
        logoSrc: "/clientes/hiper.png",
        stories: ["/clientes/stories/hiper/hiper.png"],
      },
      {
        id: "viladegust",
        name: "Vila Degust",
        logoSrc: "/clientes/rai.png",
        stories: ["/clientes/stories/viladegust/viladegust.jpeg"],
      },
      {
        id: "taine",
        name: "TD Boutique Closet",
        logoSrc: "/clientes/taine.png",
        stories: [],
      },
    ],
    []
